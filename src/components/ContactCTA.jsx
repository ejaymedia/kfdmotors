        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-snug">
              Ready to Find Your
              <br />
              <span className="text-brand-500">Perfect Vehicle?</span>
            </h2>
            <p className="text-gray-500 text-sm mt-4 leading-relaxed max-w-md">
              ...
              ready to help. Reach out today and let us make your dream
              car a reality.
            </p>
            ...
            <div className="flex flex-col gap-4 mt-8">
              {contactDetails.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl bg-brand-50 flex items-center justify-center shrink-0 group-hover:bg-brand-500 transition-colors duration-300">
                      <Icon
                        size={17}
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 mt-10">
              <button
                ...
                className="flex items-center gap-2 bg-brand-500 hover:bg-brand-600 text-white text-sm font-semibold px-7 py-3.5 rounded-full transition-all duration-300 shadow-sm hover:shadow-md"
              >
                Contact Us
                <ArrowRight size={15} />
              </button>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 border border-gray-200 hover:border-brand-500 text-gray-700 hover:text-brand-500 text-sm font-semibold px-7 py-3.5 rounded-full transition-all duration-300"
              >
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select className="bg-white border border-gray-200 rounded-xl px-4 py-3 text-gray-800 text-sm focus:outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100 transition-all appearance-none cursor-pointer">
              ...
              {/* Submit */}
              <button className="flex items-center justify-center gap-2 bg-brand-500 hover:bg-brand-600 text-white text-sm font-semibold py-3.5 rounded-xl transition-all duration-300 shadow-sm hover:shadow-md mt-1">
                Send Message
                <ArrowRight size={15} />
              </button>
            </div>
